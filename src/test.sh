...
python main.py --model PFDN --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/pfdn_x2/model/model_best.pt --test_only --n_resblocks 8 --n_feats 52

python main.py --model PFRN --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/pfrn_x2/model/model_best.pt --test_only --n_resblocks 8 --n_feats 52

python main.py --model SPFDN --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/spfdn_x2_n8f64/model/model_best.pt --test_only --n_resblocks 8 --n_feats 64 --n_threads 4 --save_results
