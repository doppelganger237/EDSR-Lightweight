...
# 训练 Full
python main.py --model EDSR_VARIANTS --scale 2 --patch_size 128 --save sr_full --n_threads 1 --use_dwconv --use_attention --n_feats 52 --n_resblocks 8 --lr 1e-4 --decay 120-200-260 --epochs 300
