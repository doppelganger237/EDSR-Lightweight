# 测试 Ghost
#python main.py --model BFFN --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/bffn_ghost/model/model_latest.pt --test_only --n_threads 0
...
#python main.py --model BFFN --scale 3 --patch_size 128 --save bffn_x3  --pre_train ../experiment/bffn_ghost/model/model_best.pt --n_threads 0 --lr 5e-4 --reset


python main.py --model BFFN --scale 2 --patch_size 128 --save local_test --n_threads 0 --lr 5e-4 --n_resblocks 8
