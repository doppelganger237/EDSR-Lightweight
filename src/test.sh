...
#Test Att_only
python main.py --model EDSR_VARIANTS --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/sr_attention_x2/model/model_best.pt --test_only --self_ensemble --save sr_attention_x2_only_y_benchmark --save_results --n_threads 0 --use_attention
