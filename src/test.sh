...
# 把路径改成你本地的 baseline checkpoint 路径
#python main.py --model EDSR_VARIANTS --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/lumisr_dwconv_attention_x2_full/model/model_best.pt --test_only --self_ensemble --save lumisr_dwconv_attention_x2_y_benchmark --save_results --n_threads 0 --use_dwconv --use_attention
